...
class MusicSlider @JvmOverloads constructor(
    ...
    var currentColor: Int
        set(value) {
            seekBar?.progressTintList = ColorStateList.valueOf(value)
            slider?.trackActiveTintList = ColorStateList.valueOf(value)
            slider?.thumbTintList = ColorStateList.valueOf(value)
        }
